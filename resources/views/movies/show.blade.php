                    ...
                    @if (count($movie['videos']['results']) > 0)
                        <div class="mt-12">
                            <button
                                ...
                                class="flex inline-flex items-center bg-yellow-600 text-gray-900 focus:outline-none focus:ring rounded font-semibold px-5 py-4 hover:bg-yellow-700 transition ease-in-out duration-150"
                            >
